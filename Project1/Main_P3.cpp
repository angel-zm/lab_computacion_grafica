 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
	   ...
	   view = glm::translate(view, glm::vec3(0.0f,0.0f,-20.0f));
		model = glm::rotate( model, 0.5f, glm::vec3( 1.0f, 3.0f, 4.0f ) ); // use to compare orthographic and perspective projection
		...
		// segundo dibujo 
		model = glm::mat4(1);
		model = glm::translate(view, glm::vec3(-5.0f, 0.0f, 0.0f));
		model = glm::rotate(model, 0.5f, glm::vec3(10.0f, 8.0f, 10.0f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(2.0f, 1.5f, 0.8f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		//glBindVertexArray(0); borra todo despues

		// tercero dibujo 

		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-15.0f, 0.0f, -15.0f));
		model = glm::rotate(model, 0.5f, glm::vec3(20.0f, 20.0f, 20.0f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 0.8f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		glBindVertexArray(0);
