...
glm::vec3 pointLightPositions[] = {
	// Esquinas del escenario (x, y, z)
	glm::vec3( 3.0f, 1.0f,  3.0f), // front-right
	glm::vec3(-3.0f, 1.0f,  3.0f), // front-left
	glm::vec3( 3.0f, 1.0f, -3.0f), // back-right
	glm::vec3(-3.0f, 1.0f, -3.0f)  // back-left
};
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[0].ambient"), 0.05f, 0.0f, 0.0f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].ambient"), 0.0f, 0.05f, 0.0f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[2].ambient"), 0.0f, 0.0f, 0.05f);
		...
		{
			// Selecciona color según la luz
			glm::vec3 lampColor;
			if (i == 0) lampColor = glm::vec3(1.0f, 0.0f, 0.0f); // rojo
			else if (i == 1) lampColor = glm::vec3(0.0f, 1.0f, 0.0f); // verde
			else if (i == 2) lampColor = glm::vec3(0.0f, 0.0f, 1.0f); // azul
			else lampColor = glm::vec3(1.0f, 1.0f, 1.0f); // blanco

			// Pasa color al shader de la lámpara
...
void KeyCallback(GLFWwindow *window, int key, int scancode, int action, int mode)
{
	...
	// Toggle con la barra espaciadora (solo en GLFW_PRESS)
